    ...
    <div class="main-container">
        ...
        <section class="admin-interface" id="admin-interface">
            <div class="container" id="content-container">
                <div class="boxx" style="background-image: url('../Image/customer.jpg');" onclick="showContent('traderprofile')">
                    <h3>Profile</h3>
                </div>
                ...
                <div class="boxx" style="background-image: url('../Image/Dashboard.jpeg');" onclick="navigateTo('http://127.0.0.1:8080/apex/f?p=4000:1:970236361032::NO:RP:FB_FLOW_ID,F4000_P1_FLOW,P0_FLOWPAGE,RECENT_PAGES:100,100,100')">
                    ...
                    <form action="" method="post">
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" id="first_name" name="first_name" value="<?php echo htmlspecialchars($fetchTrader['FIRST_NAME'], ENT_QUOTES); ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="last_name">Last Name</label>
                                <input type="text" id="last_name" name="last_name" value="<?php echo htmlspecialchars($fetchTrader['LAST_NAME'], ENT_QUOTES); ?>" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                                <label for="age">Age</label>
                                <input type="number" id="age" name="age" value="<?php echo htmlspecialchars($fetchTrader['AGE'], ENT_QUOTES); ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="phone">Phone</label>
                                <input type="tel" id="phone" name="phone" value="<?php echo htmlspecialchars($fetchTrader['PHONE'], ENT_QUOTES); ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="address">Address</label>
                            <input type="text" id="address" name="address" value="<?php echo htmlspecialchars($fetchTrader['ADDRESS'], ENT_QUOTES); ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" id="email" name="email" value="<?php echo htmlspecialchars($fetchTrader['EMAIL'], ENT_QUOTES); ?>" required>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                                <label for="gender">Gender</label>
                                <input type="text" id="gender" name="gender" value="<?php echo htmlspecialchars($fetchTrader['GENDER'], ENT_QUOTES); ?>" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                                <label for="username">Username</label>
                                <input type="text" id="username" name="username" value="<?php echo htmlspecialchars($fetchTrader['USERNAME'], ENT_QUOTES); ?>" required>
                            </div>
                            <div class="form-group password-group">
                                <label for="password">Password</label>
                                <input type="password" id="password" name="password" value="<?php echo htmlspecialchars($fetchTrader['PASSWORD'], ENT_QUOTES); ?>" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="button-container">
                                <button type="submit" id="saveButton" name="save" class="savebtn" style="display: none;">Save</button>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="modal-content">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="formh-group">
                    ...
                    <input type="text" id="shop-name" name="shop-name" value="<?php echo htmlspecialchars($fetch['SHOP_NAME'], ENT_QUOTES); ?>" required>
                </div>
                <div class="formh-group">
                    <label for="shop-email">Shop Email:</label>
                    <input type="email" id="shop-email" name="shop-email" value="<?php echo htmlspecialchars($fetch['SHOP_EMAIL'], ENT_QUOTES); ?>" required>
                </div>
                <div class="formh-group">
                ...
                <div class="formh-group">
                    ...
                    <input type="text" id="description" name="description" value="<?php echo htmlspecialchars($fetch['DESCRIPTION'], ENT_QUOTES); ?>" required>
                </div>
