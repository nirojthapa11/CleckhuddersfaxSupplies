...
<head>
    ...
    <link rel="stylesheet" href="customerSignup.css?v=<?php echo time(); ?>">
</head>
                ...
                <div class="form_content">
                    ...
                    <div class="input-group">
                        <input type="number" id="age" name="age" required placeholder="Age"
                            ...
                            <select name="gender">
                                <option value="M" <?php echo (isset($form_data['gender']) && $form_data['gender'] == 'M') ? 'selected' : ''; ?>>
                                    Male
                                </option>
                                <option value="F" <?php echo (isset($form_data['gender']) && $form_data['gender'] == 'F') ? 'selected' : ''; ?>>
                                    Female
                                </option>
                                <option value="O" <?php echo (isset($form_data['gender']) && $form_data['gender'] == 'O') ? 'selected' : ''; ?>>
                                    Other
                                </option>
                            </select>
                    </div>
                    ...
                    <p>Become a Trader? <a href="TraderSignup.php">SignUp now</a></p>
                </div>
            </div>
        </form>
    </div>
