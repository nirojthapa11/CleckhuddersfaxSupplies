        ...
        <div class="content">
            ...
            <div class="signup">
                ...
                <div class="formh-group">
                    <input type="text1" id="shop-name" name="shop-name" required placeholder="First Name">
                </div>
                <div class="formh-group">
                    <input type="tel" id="phone-number" name="phone-number" required placeholder="Last Name">
                </div>
                <div class="formh-group">
