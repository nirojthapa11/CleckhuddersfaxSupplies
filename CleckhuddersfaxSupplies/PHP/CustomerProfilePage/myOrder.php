        ...
        <div class="main_content">
            ...
            <?php
                ...
                foreach ($orders as $order) {
                    ...
                    echo "<p>Date: {$order['order_date']}</p>"; // Assuming there's an 'order_date' key in the order details
                    ...
                    echo "<th scope='col'>Sub Total (£)</th>"; // Changed from 'Total' to 'Sub Total'
                    echo "<th scope='col'>Actions</th>"; // Header for 'Actions' column
                    echo "</tr>";
                    echo "</thead>";
                    echo "<tbody>";
                    ...
                    foreach ($order['order_products'] as $product) {
                        ...
                        // Calculate subtotal taking into account quantity and discount
                        ...
                        echo "<td><button class='review-btn'>Review</button> <button class='buy-again-btn'>Buy Again</button></td>";
                        echo "</tr>";
                    }
                    echo "</tbody>";
                    echo "</table>";
